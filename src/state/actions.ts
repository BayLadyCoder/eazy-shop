...
// Types
import { CartItemType, AppState, ActionTypes } from "../Types";

// Action Types
export const API_GET_ALL_PRODUCTS_SUCCESS: string =
...
export const addToCart = (item: CartItemType): ActionTypes<CartItemType> => ({
  type: ADD_ITEM_TO_CART,
  payload: item,
});

export const removeItemFromCart = (id: number): ActionTypes<number> => ({
  type: REMOVE_ITEM_FROM_CART,
  payload: id,
});

export const apiGetAllProducts = (): ThunkAction<
  void,
  AppState,
  unknown,
  Action<string>
